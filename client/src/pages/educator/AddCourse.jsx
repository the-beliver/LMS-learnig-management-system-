     ...
     <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
      ...
      <div className='flex items-center justify-between flex-wrap'>
        <div className='flex flex-col gap-1'>
          ...
          value={coursePrice} type="number" placeholder='0' className='outline-none
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                    <img src={assets.dropdown_icon} width={14} alt="" onClick={() => handleChapter("toggle", chapter.chapterId)}
                  ...
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    ...
                    items-center mb-2'>
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins -
                        <a href={lecture.lectureUrl} target="_blank" className='text-blue-500'>Link</a> - {lecture.
      ...
      <button className='bg-black text-white w-max py-2.5 px-8
      rounded my-4'>
        ADD
      </button>
     </form>
